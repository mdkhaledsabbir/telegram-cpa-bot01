...
def main_menu(user_id):
    ...
    if user_id == ADMIN_ID:
        ...
        buttons.append("📸 স্ক্রিনশট দেখুন")  # <-- নতুন বাটন যুক্ত হল শুধুমাত্র অ্যাডমিনের জন্য
    markup.add(*buttons)
    return markup
...
def admin_edit_user_start(call):
    admin_edit_state[call.from_user.id] = {'step': 'awaiting_user_id'}
    bot.send_message(call.from_user.id, "👉 ইউজার আইডি লিখুন যেটার ব্যালেন্স আপডেট করতে চান:")
